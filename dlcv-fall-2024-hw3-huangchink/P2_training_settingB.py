...
class Block(nn.Module):
    def __init__(self, cfg):
        ...
        self.mlp = nn.Sequential(collections.OrderedDict([
            ('c_fc', lora.Linear(cfg.n_embd, 4 * cfg.n_embd,r=8)),
            ('act', nn.GELU(approximate='tanh')),
            ('c_proj', lora.Linear(4 * cfg.n_embd, cfg.n_embd,r=8))
        ]))
...
class ModifiedDecoder(nn.Module):
    def __init__(self, cfg):
        ...
        self.lm_head = lora.Linear(cfg.n_embd, cfg.vocab_size, bias=False,r=8)
...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(epochs)):
        ...
        best_model_path = f"./checkpoint/best_model2{epoch}.pth"
